...
| 3.45%  | 11.25%   | [Multi-task multi-resolution char-to-BPE cross-attention decoder for end-to-end speech recognition](https://www.isca-speech.org/archive/Interspeech_2019/pdfs/3216.pdf) | September 2019, Interspeech | Hierarchical char-to-BPE encoder-attention-decoder ( small memory footprint, 66M params) + RNN-LM  |
